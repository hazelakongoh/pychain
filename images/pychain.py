...
value_for_sender = st.text_input("sender from the user")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
value_for_receiver = st.text_input("receiver from user")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
value_for_amount = st.text_input("amount from user")
...
if st.button("Add Block"):
    ...
    # and `amount` values
    new_block = Block(
        record=Record( sender= value_for_sender,
        receiver= value_for_receiver,
        amount= value_for_amount),
        creator_id=42,
